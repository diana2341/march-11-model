...
v2 = Viewer.create(name: "diana",age:20, gender:"female")
v3 = Viewer.create(name: "bob",age:22, gender:"male")

m1 = Movie.create(name: "movie1",release_day:"monday",genre: "horror", theater_id:t1.id)
m2 = Movie.create(name: "movie2",release_day:"wednesday",genre: "horror", theater_id:t1.id)
...
t2=Ticket.create(movie_id:m2.id,viewer_id:v2.id)
t3=Ticket.create(movie_id:m3.id,viewer_id:v3.id)
